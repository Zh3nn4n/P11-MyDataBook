...
public class AnniversaryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button btnEdit = view.findViewById(R.id.btnFragAnni);
        final TextView tvAnni = view.findViewById(R.id.tvAnni);

        View dialog = inflater.inflate(R.layout.dialog,null);
        final EditText etEdit = (EditText) dialog.findViewById(R.id.etEdit);
        etEdit.setText(tvAnni.getText().toString());
        ...
        builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                tvAnni.setText(etEdit.getText().toString());
            }
        });
