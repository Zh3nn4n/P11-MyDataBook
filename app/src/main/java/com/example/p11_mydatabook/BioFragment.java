...
public class BioFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        Button btnEdit = view.findViewById(R.id.btnFragBio);
        final TextView tvBio = view.findViewById(R.id.tvBio);

        View dialog = inflater.inflate(R.layout.dialog,null);
        final EditText etEdit = (EditText) dialog.findViewById(R.id.etEdit);
        etEdit.setText(tvBio.getText().toString());
        ...
        builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                tvBio.setText(etEdit.getText().toString());
            }
        });
